...
The version of Yarn will probably be `1.22.21`, but don't worry—in your Cedar project, Corepack will know to use a modern version of Yarn because of the `packageManager` field in the root `package.json`.
