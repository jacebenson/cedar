...
If you're using another platform, see Prisma's [Data Guide](https://www.prisma.io/dataguide/postgresql/setting-up-a-local-postgresql-database?utm_source=cedarjs_docs&utm_medium=docs) for detailed instructions on how to get up and running.
...
For quick testing or prototyping, [Prisma Postgres](https://www.prisma.io/postgres?utm_source=cedarjs_docs&utm_medium=docs) offers temporary production-ready databases that require no setup or accounts. Use [`npx create-db`](https://www.prisma.io/docs/postgres/introduction/npx-create-db?utm_source=cedarjs_docs&utm_medium=docs) to create a database that's automatically deleted after 24 hours:
