...
| [`@cedarjs/router`](https://github.com/cedarjs/cedar/blob/main/packages/router/README.md)                     | The built-in router for Cedar                                                                                                                                                                                |
...
First off, thank you for your interest in contributing docs! Cedar prides itself on good developer experience, and that includes good documentation.
...
### Docs for Contributing to the Cedar Repo

These docs are in the Framework repo, cedarjs/cedar, and explain how to contribute to Cedar packages. They're the docs linked to in the table above.
