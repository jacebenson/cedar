...
Cedar uses [Jest](https://jestjs.io/) for testing.
...
const config = {
  ...
  // ☝️ load the built-in Cedar Jest configuration
}

module.exports = config
```

> You can always see Cedar's latest configuration templates in the [create-cedar-app package](https://github.com/cedarjs/cedar/blob/main/packages/create-cedar-app/templates/ts/web/jest.config.js).
