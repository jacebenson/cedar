...
We built Cedar to make building websites more accessible (we write all the config so you don't have to), but Cedar's also built to help you make more accessible websites.
