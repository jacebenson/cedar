...
export const schema = gql`
  type SubscriptionSpecFileShouldNotBeInSchema {
    id: Int!
    thisIsFromASubscriptionSpecFile: String!
  }

  extend type Query {
    subscriptionSpecFileShouldNotBeLoaded: SubscriptionSpecFileShouldNotBeInSchema
  }
`
